...
If a product-marketing-context.md exists in the workspace, read it first for context. Use that context before applying mental models. Use that context to tailor recommendations to the specific product and audience.
